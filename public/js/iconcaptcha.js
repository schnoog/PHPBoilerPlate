    ...
    $.fn.extend({
        iconCaptcha: function(options) {
            ...
            var defaults = {
                ...
                sectoken: "",
                captchaAjaxFile: '/captcha-request',
                captchaMessages: {
            ...
            return this.each(function(id) {
                ...
                function loadCaptcha(captchaTheme, iconHolder, loadDelay) {
                    $.ajax({
                        ...
                        type: 'post',
                        data: {cID: $captcha_id, rT : 1, tM: captchaTheme, token: $options.sectoken},
                ...
                function submitCaptcha(captcha) {
                    ...
                    if(clicked_class) {
                        ...
                        $.ajax({
                            url: $options.captchaAjaxFile,
                            type: 'post',
                            data: {cID: $captcha_id, pC: clicked_class, rT : 2, token: $options.sectoken},
                            success: function (data) {
